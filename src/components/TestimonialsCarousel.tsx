          ...
          {testimonials.map((t, idx) => (
            ...
            >
              <motion.div
                ...
                className={`w-full h-auto p-6 md:p-8 rounded-[1.5rem] flex flex-col justify-between ${t.color} border border-primary/5 transition-all shadow-sm hover:shadow-md`}
              >
                <div>
                  ...
                  <blockquote className="text-text-navy text-sm md:text-base leading-relaxed mb-4">
                    &ldquo;{t.quote}&rdquo;
                  </blockquote>
                </div>
